...
# ~/prog/pwa/PWA.pm
# our $VERSION=2017.020701; # PWA cloned into first PWA_B
#
# SECURITY NOTE (20201116):
# way how to compile:
# perl -MO=Bytecode,-H,-oPWA_B.pm PWA_B_SRC.pm
#
# Compilation into Bytecode improves security a bit 
# as hides alghoritm behind unauthorized eyes
# ... but requires functional B:: or Byteloader.pm Libraries.
#
# Since 5.8.x> B:: libraries seems to be comercial only :-(
# For functional compiled scripts (customer side) you need functional "Byteloader.pm"
# For functional compilation process (developer side) you 
# need functional B::Bytecode, B::C, B::S libraries ...B::C is the most usual issue.
#
